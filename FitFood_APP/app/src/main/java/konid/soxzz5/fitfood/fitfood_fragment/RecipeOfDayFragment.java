...
public class RecipeOfDayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(bundle_tmp != null) {
            recipe_key = bundle_tmp.getString("recipe_key");
            databaseReference = FirebaseDatabase.getInstance().getReference().child("recipe");
            databaseReference.child(recipe_key).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
