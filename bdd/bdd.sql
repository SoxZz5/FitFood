...
CREATE TABLE IF NOT EXISTS `db_a1452a_fitfood`.`ingredient` (
  ...
  `subcategory_categorie_idcategorie` INT NOT NULL,
  PRIMARY KEY (`idingredient`, `subcategory_idsubcategory`, `subcategory_categorie_idcategorie`),
  INDEX `fk_ingredient_subcategory1_idx` (`subcategory_idsubcategory` ASC, `subcategory_categorie_idcategorie` ASC),
  CONSTRAINT `fk_ingredient_subcategory1`
    FOREIGN KEY (`subcategory_idsubcategory` , `subcategory_categorie_idcategorie`)
    REFERENCES `db_a1452a_fitfood`.`subcategory` (`idsubcategory` , `categorie_idcategorie`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_a1452a_fitfood`.`recipe_categorie` (
  ...
  `subcategory_idsubcategory` INT NOT NULL,
  `subcategory_categorie_idcategorie` INT NOT NULL,
  PRIMARY KEY (`recipe_idrecipe`, `subcategory_idsubcategory`, `subcategory_categorie_idcategorie`),
  INDEX `fk_recipe_categorie_subcategory1_idx` (`subcategory_idsubcategory` ASC, `subcategory_categorie_idcategorie` ASC),
  CONSTRAINT `fk_recipe_categorie_recipe1`
    FOREIGN KEY (`recipe_idrecipe`)
    REFERENCES `db_a1452a_fitfood`.`recipe` (`idrecipe`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_recipe_categorie_subcategory1`
    FOREIGN KEY (`subcategory_idsubcategory` , `subcategory_categorie_idcategorie`)
    REFERENCES `db_a1452a_fitfood`.`subcategory` (`idsubcategory` , `categorie_idcategorie`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
